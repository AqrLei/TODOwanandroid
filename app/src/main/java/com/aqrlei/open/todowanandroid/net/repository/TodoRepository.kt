...
class TodoRepository {
    ...
    interface TodoService {
        ...
        fun fetchTypeList(@Path("type") type: String): LiveObservable<BaseRespBean<TodoTypeRespBean>>

        @POST("lg/todo/listdone/{type}/json/{page}")
        fun fetchDoneList(
            @Path("type") type: String,
            @Path("page") pageNum: String
        ): LiveObservable<BaseRespBean<TodoTypeRespBean>>
        ...
        ): LiveObservable<BaseRespBean<Any>>

        @POST("lg/todo/delete/{id}/json")
        fun delete(@Path("id") id: String): LiveObservable<BaseRespBean<Any>>
        ...
        fun addNew(@Body reqBean: TodoReqBean): LiveObservable<BaseRespBean<Any>>
    }
}